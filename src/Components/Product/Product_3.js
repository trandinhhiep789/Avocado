    ...
    <div className="pro3 m-3">
      <div className="card" style={{ width: "15rem" }}>
              ...
              <div className="row">
                ...
                <div className="col-xl-6 contentModal">
                  ...
                  <div className=" d-flex">
                    <p className=" fw-bolder">309,000đ</p>
                    <p
                      className=" mx-2"
        ...
        <div className="card-body">
          ...
          <p className="noiDungCard">Gel Rửa Mặt Dành Cho Da Dầu Nhạy Cảm</p>
          <div className="gia d-flex">
            <p className="giaHienTai fw-bolder">309,000đ</p>
