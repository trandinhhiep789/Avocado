    ...
    <div className="pro6 m-3">
      <div className="card" style={{ width: "15rem" }}>
              ...
              <div className="row">
                ...
                <div className="col-xl-6 contentModal">
                  ...
                  <div className=" d-flex">
                    <p className=" fw-bolder">260,000đ</p>
                    <p
                      className=" mx-2"
        ...
        <div className="card-body">
          ...
          <p className="noiDungCard">Xịt khoáng giúp làm sạch và làm dịu da</p>
          <div className="gia d-flex">
            <p className="giaHienTai fw-bolder">260,000đ</p>
